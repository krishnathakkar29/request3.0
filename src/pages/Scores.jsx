    ...
    <>
      {!allScores[team] || loading ? (
        ...
        <>
          ...
          <div
            className={` bg-container bg-opacity-90 w-full h-full min-h-screen overflow-auto bg-fixed bg-cover bg-no-repeat object-cover m-0 scrollbar-hide md:pl-64 flex flex-col justify-center items-center pt-20 md:pt-0`}
          >
            <div
